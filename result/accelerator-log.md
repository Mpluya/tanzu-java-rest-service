...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=Mpluya&repo=tanzu-java-rest-service"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=tanzu-java-rest-service'
